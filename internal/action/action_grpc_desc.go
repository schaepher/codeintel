...
// R92 迁移：ServiceDesc 方法全集提取（原 cli/query_grpc_routes_desc.go
// 的 serviceDescMethods/methodDescs/astExprString）——go/parser 提取
// 生成代码方法列表；输出格式化（cmdGrpcRoutes）留 cli。
